...
output:
 set val(name), file("final_reads/*q")  into g124_32_reads_g_68
...
input:
 val run from g_119_run_Homer_g134_7

output:
 val run  into g134_7_run_process_g134_1
...
if [ ! -d "${params.homer_dir}/data" ]; then
  ...
  cp ${params.configureHomer_path} ${params.homer_dir}/. 2>/dev/null
...
input:
 file bed from g128_9_bed_g134_1
 val run from g134_7_run_process_g134_1

output:
 file "homer_${name}"  into g134_1_resultsdir_g134_5
...
input:
 file dir from g134_1_resultsdir_g134_5.collect()

output:
 file "homerReport*"  into g134_5_resultsdir
...
output:
 file "multiqc_report.html" optional true  into g_79_outputHTML
...
g124_14_outputFileTSV_g_115= g124_14_outputFileTSV_g_115.ifEmpty([""]) 
g127_11_outputFileTSV_g_115= g127_11_outputFileTSV_g_115.ifEmpty([""]) 
g123_11_outputFileTSV_g_115= g123_11_outputFileTSV_g_115.ifEmpty([""]) 
g123_21_outputFileTSV_g_115= g123_21_outputFileTSV_g_115.ifEmpty([""]) 
g123_16_outputFileTSV_g_115= g123_16_outputFileTSV_g_115.ifEmpty([""]) 
g128_23_outputFileTSV_g_115= g128_23_outputFileTSV_g_115.ifEmpty([""]) 
